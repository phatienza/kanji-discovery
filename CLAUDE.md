# CLAUDE.md — Kanji Discovery Project

Project context and instructions for AI coding agents (Claude Code / Codex).
...
- All game state in memory / localStorage. (localStorage is fine here — this
  is a deployed static site, not a claude.ai artifact.)
